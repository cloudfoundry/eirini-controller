...
require (
	...
	code.cloudfoundry.org/executor v0.0.0-20210607175520-fcbc9a20ecd8 // indirect
	code.cloudfoundry.org/go-diodes v0.0.0-20190809170250-f77fb823c7ee // indirect
	code.cloudfoundry.org/go-loggregator v7.4.0+incompatible // indirect
	code.cloudfoundry.org/lager v2.0.0+incompatible
	code.cloudfoundry.org/locket v0.0.0-20210602163139-2dc37fffb2b4 // indirect
	code.cloudfoundry.org/rep v0.0.0-20210607145839-44a0f912e069 // indirect
