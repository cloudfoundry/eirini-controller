...
func (fake *FakeLRPClient) Desire(arg1 context.Context, arg2 *v1.LRP) error {
...
func (fake *FakeLRPClient) DesireCalls(stub func(context.Context, *v1.LRP) error) {
	fake.desireMutex.Lock()
	defer fake.desireMutex.Unlock()
	fake.DesireStub = stub
}

func (fake *FakeLRPClient) DesireArgsForCall(i int) (context.Context, *v1.LRP) {
	fake.desireMutex.RLock()
	defer fake.desireMutex.RUnlock()
...
func (fake *FakeLRPClient) GetStatus(arg1 context.Context, arg2 *v1.LRP) (v1.LRPStatus, error) {
...
func (fake *FakeLRPClient) GetStatusCalls(stub func(context.Context, *v1.LRP) (v1.LRPStatus, error)) {
	fake.getStatusMutex.Lock()
	defer fake.getStatusMutex.Unlock()
	fake.GetStatusStub = stub
}

func (fake *FakeLRPClient) GetStatusArgsForCall(i int) (context.Context, *v1.LRP) {
	fake.getStatusMutex.RLock()
	defer fake.getStatusMutex.RUnlock()
...
func (fake *FakeLRPClient) Update(arg1 context.Context, arg2 *v1.LRP) error {
...
func (fake *FakeLRPClient) UpdateCalls(stub func(context.Context, *v1.LRP) error) {
	fake.updateMutex.Lock()
	defer fake.updateMutex.Unlock()
	fake.UpdateStub = stub
}

func (fake *FakeLRPClient) UpdateArgsForCall(i int) (context.Context, *v1.LRP) {
	fake.updateMutex.RLock()
	defer fake.updateMutex.RUnlock()
